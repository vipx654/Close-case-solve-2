...
ᴡᴇ ʜᴀᴠᴇ ᴅᴇᴠɪᴅᴇᴅ ʙᴏᴛ ᴄᴏᴍᴍᴀɴᴅꜱ ꜰᴏʀ ɢʀᴏᴜᴘ ᴏᴡɴᴇʀꜱ ᴀɴᴅ ʙᴏᴛ ᴜꜱᴇʀꜱ.</b>"""
    ...
    ABOUT_TXT = """<b>‣ ᴍʏ ɴᴀᴍᴇ : {}\n‣ ᴄʀᴇᴀᴛᴏʀ : <a href='https://t.me/from_Admins_desk'>ᴀᴅᴍɪɴ</a>\n‣ ʟɪʙʀᴀʀʏ : ᴘʏʀᴏɢʀᴀᴍ\n‣ ʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ\n‣ ᴅᴀᴛᴀ ʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ\n‣ ʜᴏsᴛᴇᴅ ᴏɴ  : ʜᴇʀᴏᴋᴜ\n‣ ʙᴜɪʟᴅ sᴛᴀᴛᴜs : ᴠ4.2 [sᴛᴀʙʟᴇ]</b>"""
...
ᴘʟᴇᴀꜱᴇ ꜱᴇɴᴅ ᴛʜᴇ ʀᴇǫᴜᴇꜱᴛ ᴀɢᴀɪɴ."""
    ...
    I_CUDNT = """<b>🔍 sᴇᴀʀᴄʜᴇᴅ ꜰᴏʀ :</b> <code>{}</code>

<b>😔 ɴᴏᴛ ꜰᴏᴜɴᴅ ɪɴ ᴏᴜʀ ᴅᴀᴛᴀʙᴀsᴇ ʏᴇᴛ!</b>

<b>✅ ʏᴏᴜʀ ʀᴇǫᴜᴇsᴛ ʜᴀs ʙᴇᴇɴ ɴᴏᴛᴇᴅ ✍️
   ᴡᴇ'ʟʟ ᴛʀʏ ᴛᴏ ᴀᴅᴅ ɪᴛ ꜱᴏᴏɴ! 🚀</b>

<b>💡 ᴛɪᴘs ᴛᴏ ꜰɪɴᴅ ꜰᴀsᴛᴇʀ :</b>
<b>▸ ᴛʀʏ sᴇᴀʀᴄʜɪɴɢ ᴡɪᴛʜ ᴛʜᴇ ʏᴇᴀʀ  (ᴇɢ: ᴋɢꜰ 2022)
▸ ᴜsᴇ ᴇɴɢʟɪsʜ ꜱᴘᴇʟʟɪɴɢ
▸ ᴛᴀᴘ 📝 ʀᴇǫᴜᴇsᴛ ʙᴇʟᴏᴡ ᴛᴏ ᴀʟᴇʀᴛ ᴀᴅᴍɪɴ</b>"""

    I_CUD_NT = """<b>🔍 sᴇᴀʀᴄʜᴇᴅ ꜰᴏʀ :</b> <code>{}</code>
...
▸ ᴛᴀᴘ 📝 ʀᴇǫᴜᴇsᴛ ʙᴇʟᴏᴡ ᴛᴏ ᴀʟᴇʀᴛ ᴀᴅᴍɪɴ</b>"""
    ...
    MVE_NT_FND = """<b>😔 ɴᴏ ꜰɪʟᴇs ꜰᴏᴜɴᴅ ɪɴ ᴏᴜʀ ᴅᴀᴛᴀʙᴀsᴇ ʏᴇᴛ!</b>
...
🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://t.me/from_Admins_desk'>ʜᴘ</a></b>"""
...
• ᴍᴀɪɴ ᴏᴡɴᴇʀ : <a href="https://t.me/from_Admins_desk">Hᴀʀꜱʜᴀʟ ❤️‍🔥</a>
...
""" 
   # PLEASE DO NOT REMOVE ANY CREDITS ❤️‍🩹
    ...
    CAPTION = """ 📂 <i><a href="https://telegram.me/from_Admins_desk">{file_name}</a></i>\n\n"""
...
💵 ᴜᴘɪ ɪᴅ - <code>k-vipul@ptyes</code>
...
🏆 ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴀ ɴᴇᴡ ᴘʟᴀɴ ᴀᴘᴀʀᴛ ꜰʀᴏᴍ ᴛʜᴇ ɢɪᴠᴇɴ ᴘʟᴀɴ, ᴛʜᴇɴ ʏᴏᴜ ᴄᴀɴ ᴛᴀʟᴋ ᴛᴏ ᴏᴜʀ <a href='https://t.me/from_Admins_desk'>ᴀᴅᴍɪɴ</a> ᴅɪʀᴇᴄᴛʟʏ ʙʏ ᴄʟɪᴄᴋɪɴɢ ᴏɴ ᴛʜᴇ ᴄᴏɴᴛᴀᴄᴛ ʙᴜᴛᴛᴏɴ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ.
...
-Dev [Owner of this bot ]<a href='https://t.me/from_Admins_desk'>HP</a>
"""
